...
<!-- COUNT -->11<!-- /COUNT --> of them. It also contains a verifier that proves
...
| 11 | √3 + 1/4 = 1.982051 | Maurizio Morandi, Apr 2009 | **1.983717455** | +0.001667 | [svg](figures/tri_square_11.svg) · [cert](certificates/tri_square_11.json) |

### Squares covering circles (radius r)

| n | previous record | holder | new value (verified) | improvement | files |
|---|---|---|---|---|---|
| 7 | 1.239+ | David Cantrell, Jul 2002 | **1.241885665** | ≥ +0.0019 | [svg](figures/sq_disk_07.svg) · [cert](certificates/sq_disk_07.json) |
| 8 | 1.375+ | Maurizio Morandi, Mar 2009 | **1.376427184** | ≥ +0.0004 | [svg](figures/sq_disk_08.svg) · [cert](certificates/sq_disk_08.json) |
| 12 | 1.701+ | David Cantrell, Aug 2002 | **1.712399285** | ≥ +0.0104 | [svg](figures/sq_disk_12.svg) · [cert](certificates/sq_disk_12.json) |
| 13 | 1.779+ | Maurizio Morandi, Apr 2009 | **1.781493254** | ≥ +0.0015 | [svg](figures/sq_disk_13.svg) · [cert](certificates/sq_disk_13.json) |
| 17 | 2.042+ | Maurizio Morandi, Jun 2009 | **2.047182901** | ≥ +0.0042 | [svg](figures/sq_disk_17.svg) · [cert](certificates/sq_disk_17.json) |
...
and its contributors, among them Trevor Green, David Cantrell and Maurizio
Morandi. This project was built with [Claude Code](https://claude.com/claude-code).
